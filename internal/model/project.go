...
type Project struct {
	...
	CompletionBonus uint     `gorm:"default:0" json:"completion_bonus" excel:"完成奖励积分"`              // 完成项目所有栏目后的额外奖励积分，0表示无奖励
	ExemptFromLimit bool     `gorm:"default:false" json:"exempt_from_limit" excel:"不计入每日上限"`        // 该项目的积分是否不计入活动每日积分上限
	// 关联到用户
